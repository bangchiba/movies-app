      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between px-4 py-6">
          <ul className="flex flex-col md:flex-row items-center">
              ...
              <li className="md:ml-16 mt-3 md:mt-0">
                  <a href="{{ route('movies.index') }}" className="hover:text-gray-300">Movies</a>
              </li>
              <li className="md:ml-6 mt-3 md:mt-0">
                  <a href="{{ route('tv.index') }}" className="hover:text-gray-300">TV Shows</a>
              </li>
              <li className="md:ml-6 mt-3 md:mt-0">
                  <a href="{{ route('actors.index') }}" className="hover:text-gray-300">Actors</a>
              </li>
          </ul>
